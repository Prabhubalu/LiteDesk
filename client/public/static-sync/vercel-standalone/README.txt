...
5. Deploy — build syncs only changed help pages (publish webhooks stay incremental)

Run `npm run sync:help:full` (or re-run the Arivu install curl script) to regenerate every help page after template updates.
