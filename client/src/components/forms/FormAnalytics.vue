<template>
  <div class="space-y-6">
    ...
    <div v-if="loading" class="text-center py-12">
      ...
      <p class="text-gray-600 dark:text-gray-400">{{ t('forms.analyticsLoading') }}</p>
    </div>
    ...
    <div v-else class="space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ t('forms.analyticsComplianceTrend') }}</h3>
          <ComplianceTrendChart :form-id="formId" />
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ t('forms.analyticsRatingDistribution') }}</h3>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ t('forms.analyticsSectionScores') }}</h3>
          <SectionScoresChart :form-id="formId" :form="form" />
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ t('forms.analyticsResponseRate') }}</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ t('forms.analyticsTopFailedQuestions') }}</h3>
