  ...
  <div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      <div class="flex items-center justify-between mb-6">
        <div>
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('settings.settingsHierarchyChartTitle') }}</h3>
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
            {{ t('settings.settingsHierarchyChartSubtitle') }}
          </p>
        </div>
        <button
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
      <h4 class="text-sm font-semibold text-blue-900 dark:text-blue-300 mb-2">{{ t('settings.settingsHierarchyLegendTitle') }}</h4>
      <ul class="text-xs text-blue-800 dark:text-blue-400 space-y-1">
        <li>• {{ t('settings.settingsHierarchyLegendLevel0') }}</li>
        <li>• {{ t('settings.settingsHierarchyLegendParentRole') }}</li>
        <li>• {{ t('settings.settingsHierarchyLegendLines') }}</li>
        <li>• {{ t('settings.settingsHierarchyLegendUserCount') }}</li>
        <li>• {{ t('settings.settingsHierarchyLegendClickRole') }}</li>
      </ul>
    </div>
  </div>
</template>
