      ...
      <div class="fixed inset-0 overflow-hidden">
        <div class="absolute inset-0 overflow-hidden">
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
            ...
            >
              <DialogPanel
                class="rounded-tl-xl overflow-hidden pointer-events-auto flex h-full w-screen max-w-2xl flex-col bg-white shadow-xl dark:bg-gray-800"
              >
                <form class="relative flex h-full flex-col" @submit.prevent="handleSubmit">
                  ...
                  <div
                    class="flex-shrink-0 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-6 sm:px-6"
                  >
                    <div class="flex items-center justify-between">
                      <DialogTitle class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">{{ t('people.salesConvertLeadModalConvertLeadToContact') }}</DialogTitle>
                      <button
                        type="button"
