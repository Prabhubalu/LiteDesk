  ...
  <div class="flex min-h-0 flex-1 flex-col">
    <div class="border-b border-neutral-200 px-3 py-2 dark:border-neutral-800">
      <input
        ...
        type="search"
        :class="ui.input"
        :placeholder="t('contentStudio.searchTemplates')"
      />
    </div>
...
import { getArticleTemplatesForMode } from '../editor/articleTemplates';
...
const filtered = computed(() => {
  const items = getArticleTemplatesForMode(props.mode === 'blog' ? 'blog' : 'articles');
