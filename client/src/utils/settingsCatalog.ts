...
export const SETTINGS_CATALOG: SettingsCatalogEntry[] = [
  ...
  leaf({
    ...
    order: 64,
    lane: 'workspace',
    aliases: ['price book', 'pricebook', 'list price'],
  }),
  leaf({
    id: 'catalog.pricing',
    parentId: 'catalog',
    labelKey: 'settings.catalogTabPricing',
    descriptionKey: 'settings.tabCatalogDesc',
    route: '/settings?tab=catalog&catalogView=pricing',
    order: 64.2,
    lane: 'workspace',
    aliases: ['pricing', 'pricing rules', 'promotions', 'price engine'],
  }),
  leaf({
  ...
  leaf({
    id: 'catalog.product-configurations',
    parentId: 'catalog',
    labelKey: 'settings.catalogTabProductConfigs',
    descriptionKey: 'settings.tabCatalogDesc',
    route: '/settings?tab=catalog&catalogView=product-configurations',
    order: 64.6,
    lane: 'workspace',
    aliases: ['product configuration', 'cpq configuration', 'configure products'],
  }),
  leaf({
    id: 'inventory.taxes',
    parentId: 'inventory',
