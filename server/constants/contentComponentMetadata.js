 ...
 * Keep in sync with client/src/constants/contentComponentMetadata.ts
 */

const { CONTENT_COMPONENT_TYPES } = require('./contentComponentRegistry');

/** @typedef {'full'|'partial'|'none'|'single_page'} OutputSupportLevel */

/**
 * @typedef {object} ComponentOutputSupport
 * @property {OutputSupportLevel} [print]
 * @property {OutputSupportLevel} [pdf]
 * @property {OutputSupportLevel} [email]
 * @property {OutputSupportLevel} [html]
 * @property {OutputSupportLevel} [portal]
 * @property {OutputSupportLevel} [label]
 */

/**
 * @typedef {'all'|'all_except_page'|'none'|string[]} AllowedChildrenPolicy
 */

/**
 * @typedef {object} ContentComponentMetadataEntry
 * @property {string} type
 * @property {string} category
 * @property {string} purpose
 * @property {string[]} howItWorks
 * @property {ComponentOutputSupport} supportedOutputs
 * @property {AllowedChildrenPolicy} allowedChildren
 * @property {string[]} keyProperties
 * @property {string[]} specialBehaviors
 * @property {string[]} [dataBinding]
 * @property {string[]} [validationRules]
 * @property {string} aiDescription
 * @property {boolean} [inBuilderCatalog]
 */
...
/** @type {Record<string, ContentComponentMetadataEntry>} */
const CONTENT_COMPONENT_METADATA = Object.freeze({
...
/**
 * @param {string} type
 * @returns {ContentComponentMetadataEntry|null}
 */
function getContentComponentMetadata(type) {
 ...
 * @returns {boolean}
 */
function isAllowedChildComponent(parentType, childType) {
...
module.exports = {
  CONTENT_COMPONENT_OUTPUT_LEVELS: OUTPUT,
  CONTENT_COMPONENT_CHILDREN_POLICIES: CHILDREN,
