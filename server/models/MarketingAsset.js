...
const MarketingAssetSchema = new Schema(
  {
    ...
    type: { type: String, enum: MARKETING_ASSET_TYPES, required: true, index: true },
...
MarketingAssetSchema.index({ organizationId: 1, assetId: 1 }, { unique: true });

module.exports = wrapTenantModel(mongoose.model('MarketingAsset', MarketingAssetSchema));
